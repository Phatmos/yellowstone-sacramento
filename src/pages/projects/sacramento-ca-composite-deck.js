    ...
    return (
        <Layout>
            <Helmet>
                ...
                <meta
                    name="keywords"
                    content="composite deck Sacramento CA, deck builder Sacramento CA, Trex deck Sacramento, composite decking California, deck replacement Sacramento CA, deck contractor Sacramento California, Yellowstone Renovation deck"
                />

                {/* OG */}
                <meta property="og:type" content="website" />
                <meta property="og:title" content="Composite Deck Builder in Sacramento, CA | Yellowstone Renovation" />
                <meta
                    property="og:description"
                    content="Custom composite deck installation in Sacramento, CA by Yellowstone Renovation. Modern outdoor living space with picture-frame decking, stairs, and premium finishes."
                />
                ...
                <meta name="twitter:title" content="Sacramento CA Composite Deck Project" />
                <meta
                    name="twitter:description"
                    content="See this custom composite deck built in Sacramento, CA with premium materials and expert craftsmanship."
                />
    ...
    ========================== */}
                <script type="application/ld+json">
                    {JSON.stringify({
                        "@context": "https://schema.org",
                        "@type": "Product",
                        "name": "Composite Deck Project in Sacramento, CA",
                        "image": heroImage,
                        "description":
                            "Modern composite deck rebuild in Sacramento, CA featuring picture-frame decking, stairs, and premium finishes installed by Yellowstone Renovation.",
                        "brand": {
                            "@type": "Brand",
                            "name": "Yellowstone Renovation"
                        },
    ...
    ========================== */}
                <script type="application/ld+json">
                    {JSON.stringify({
                        "@context": "https://schema.org",
                        "@type": "CreativeWork",
                        "name": "Composite Deck & Concrete Upgrade in Sacramento, CA",
                        "description":
                            "Completed composite deck and concrete project in Sacramento, California by Yellowstone Renovation.",
                        "image": heroImage,
                        "author": {
                            "@type": "Organization",
                            "name": "Yellowstone Renovation"
